...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" version="1.0">
    ...
    <xsl:template match="tei:TEI">
        ...
        <html>
            ...
            <body>
                <div id="doc_header">
                    <div style="margin-bottom:0.2em;padding:20px;letter-spacing:0.3em;font-family:Helvetica Neue,Arial,sans-serif;font-size:18pt;">Themenregister</div>
